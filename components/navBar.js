...
export function NavBar() {
    ...
    return (
        <>
            {/* Navbar */}
            <nav className="item-blur border-b dark:border-zinc-700 border-gray-300 bg-fixed select-none fixed w-full top-0 z-10">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-1 px-6">
                    ...
                    >
                        <ul className="flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0 md:border-0">
                            <li className="py-3 font-outfit transition duration-300 ease-in-out text-lg">
                                <DropdownMenu>
                            ...
                            <li className="py-2 transition duration-300 ease-in-out text-lg md:mx-32">
                                <DropdownMenu>
