    ...
    return (
        <body style={{ backgroundColor: bgColor }}>
            <main>
                ...
                <h4 className="font-mono opacity-90 md:mt-[100px] mt-32 text-md font-medium text-center" style={{ color: textColor }}>FRESH FEATURES<br /><span className="font-inter font-bold text-2xl">Version 1.5 - Apple green, Blogfolio</span></h4>
                <div className="flex justify-center md:mx-0 px-6">
                    <Card className="backdrop-blur-lg bg-white/30 dark:bg-black/30 p-10 mt-5 mx-20 md:mx-32 md:w-full">
                        <CardContent>
                            <div className="flex justify-center gap-2 w-max -mb-1">
                                <h1 className="font-inter md:text-[120px] text-[100px] font-bold" style={{ color: textColor }}>1.5</h1>
                                <img src="green_heart.svg" className="md:h-32 md:w-32 h-[100px] w-[100px] mt-6"></img>
                            </div>
                            <Link href={"/blog/1.5"}>
                                <Button className="bottom-0 right-0 absolute md:visible rounded-full p-4 m-10 hover:translate-x-1 transition-all ease-in" style={{ color: accentColor, backgroundColor: secondaryColor }}>
                                    <ArrowRightIcon />
                                </Button>
                            </Link>
                        </CardContent>
                ...
                <h4 className="font-mono opacity-90 md:mt-[60px] mt-10 text-md font-medium text-center" style={{ color: textColor }}>USER INTERFACE OVERHAUL<br /><span className="font-inter font-bold text-2xl">Version 1.4 - Mobile controls, UI overhaul</span></h4>
                <div className="flex justify-center md:mx-0 px-6">
                    <Card className="backdrop-blur-lg bg-white/30 dark:bg-black/30 p-10 mt-5 mx-20 md:mx-32 md:w-full mb-32">
                        <CardContent>
                            <div className="flex justify-center gap-2 w-max -mb-1">
                                <h1 className="font-inter md:text-[120px] text-[100px] font-bold" style={{ color: textColor }}>1.4</h1>
                                <img src="orange_heart.svg" className="md:h-32 md:w-32 h-[100px] w-[100px] mt-6"></img>
                            </div>
                            <Link href={"/blog/1.4"}>
                                <Button className="bottom-0 right-0 absolute md:visible rounded-full p-4 m-10 hover:translate-x-1 transition-all ease-in" style={{ color: accentColor, backgroundColor: secondaryColor }}>
                                    <ArrowRightIcon />
